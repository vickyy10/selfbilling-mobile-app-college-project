...
public class generate_bill_2 extends AppCompatActivity {
    ...
    String url;
    ArrayList<String> prod,qty,prc,bdid;
    int tp=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url ="http://"+sh.getString("ip", "") + ":5000/generate_bill2";


        RequestQueue queue = Volley.newRequestQueue(generate_bill_2.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    t1.setText(tp+"");
                    l1.setAdapter(new edit_custom_view_3(generate_bill_2.this,prod,qty,prc,bdid));
...
//                            l1.setOnItemClickListener(viewuser.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(generate_bill_2.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    showDialog(generate_bill_2.this, "No Scanner Found", "Download a scanner code activity?", "Yes", "No").show();
                }
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("success")) {
                                        Toast.makeText(generate_bill_2.this, "Added", Toast.LENGTH_SHORT).show();

                                        Intent i = new Intent(getApplicationContext(), generate_bill_1.class);
                                        startActivity(i);
...
//                Toast.makeText(getApplicationContext(),"res"+contents,Toast.LENGTH_LONG).show();
                ...
                Intent int_qrpfl = new Intent(getApplicationContext(), generate_bill_3.class);
