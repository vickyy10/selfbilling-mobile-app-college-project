...
public class costum3 extends BaseAdapter{
    ...
    public costum3(Context applicationContext, ArrayList<String> a, ArrayList<String> b,ArrayList<String> c) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_costum3, null);
