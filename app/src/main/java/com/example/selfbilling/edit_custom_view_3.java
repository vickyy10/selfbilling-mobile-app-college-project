...
public class edit_custom_view_3 extends BaseAdapter{
    ...
    public edit_custom_view_3(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c,ArrayList<String> d) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_edit_custom_view3, null);
...
//        Button b2=(Button)gridView.findViewById(R.id.button29);
...
//
//                Intent i= new Intent(context, edit_generate_bill.class);
//
...
////                                        ed.putString("lid", id);
////                                        ed.commit();
//                                        Intent i=new Intent(context,generate_bill_2.class);
//                                        context.startActivity(i);
//                                    } else {
